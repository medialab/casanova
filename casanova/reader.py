...
def make_casanova_reader(name, namespace, reader_fn):

    class AbstractCasanovaReader(object):
        __name__ = name

        def __init__(self, input_file, no_headers=False):

            self.input_file = input_file
            self.reader = reader_fn(input_file)
    ...
    return AbstractCasanovaReader


CasanovaReader = make_casanova_reader('CasanovaReader', 'casanova.reader', csv.reader)
